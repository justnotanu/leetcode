<h2> 721 171
891. Sum of Subsequence Widths</h2><hr><div><p>The <strong>width</strong> of a sequence is the difference between the maximum and minimum elements in the sequence.</p>
